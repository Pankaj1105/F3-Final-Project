window.addEventListener("load", () => {
  ...
  $.getJSON("https://api.ipify.org?format=json", function(data) {
    ...
    document.querySelector(".btn-getip").addEventListener("click", () => {
      ...
      let chicago_datetime_str = new Date().toLocaleString("IN", { timeZone: "Asia/Kolkata" });
  ...
  console.log(chicago_datetime_str);
      ...
      fetch(
        ...
        .then((data) => {
          ...
          iframeData.src = `https://maps.google.com/maps?q=18.6161,73.7286&hl=es;&output=embed`;
